...
doors = ((4 < x) & (x < 7)) | ((13 < x) & (x < 16)) | ((14 < y) & (y < 17))|(y<7)
...
X, Y = np.meshgrid(X, Y)
grid[ dist((X,Y),(5,4))<1.5 ]=1
grid[ dist((X,Y),(12,4))<1.5 ]=1

grid[ dist((X,Y),(0,20))<1.5 ]=1
grid[ dist((X,Y),(3,15))<1.5 ]=1
grid[ dist((X,Y),(13,2))<1.0 ]=1
grid[ dist((X,Y),(12,13))<1.0 ]=1
